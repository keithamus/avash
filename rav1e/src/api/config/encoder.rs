...
pub struct EncoderConfig {
  ...
  /// Fixed Wiener loop-restoration taps `[luma, chroma]`, applied to every
  /// restoration unit in place of the RDO search. Each entry is the outer
  /// three taps of the symmetric 7-tap filter; `chroma[0]` must be 0.
  /// Forces loop restoration on regardless of frame size.
  pub wiener: Option<[[i8; 3]; 2]>,
}
